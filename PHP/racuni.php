...
<head>
    ...
    <style>
        body { background-color: #1a1a1a !important; color: #ccc !important; font-family: Arial, sans-serif; padding: 0; margin: 0; }
        ...
        .table { width: 100%; border-collapse: collapse; margin-top: 20px; background-color: #ffffff !important; }
